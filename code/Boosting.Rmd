...
```{r pd1, echo = TRUE, fig.width = 5, fig.height = 3, out.width = "100%", fig.align='center', fig.cap = "Partial Dependence Plot for Explamation Point.", fig.pos = "H"}
plot(gbm_3, i.var = "housing_density", 
     n.trees = optimal_num_trees)
```

```{r pd2, echo = TRUE, fig.width = 5, fig.height = 3, out.width = "100%", fig.align='center', fig.cap = "Partial Dependence Plot for Dollar Sign.", fig.pos = "H"}
plot(gbm_3, i.var = "poor_fair_health", 
     n.trees = optimal_num_trees)

```

```{r pd3, echo = TRUE, fig.width = 5, fig.height = 3, out.width = "100%", fig.align='center', fig.cap = "Partial Dependence Plot for 'remove'.", fig.pos = "H"}
