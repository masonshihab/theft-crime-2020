...
```{r}
file = "/Users/diyangchu/Documents/2-grad@Penn/STAT471/theft-crime-2020/data/raw/scorecard.csv"
...
scorecard_raw %>% select(-fips_state_code,-fips_county_code) %>% mutate(fips = as.numeric(fips))
